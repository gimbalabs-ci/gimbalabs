    ...
    <div className="w-full h-full bg-offWhite min-h-screen ">
      ...
      <div className="spacing-x mb-7 text-black2-900">
        ...
        <div className="max-w-15">
          Right now, a group of 34 people from across the Cardano ecosystem are working together to create plans for the Gimbal token. Our work is iterative, and this process will continue over six more "Allocation Rounds".
        </div>
        <h2 className="text-2xl py-4">
          Earn Gimbals Now
        </h2>
