    ...
    return (
        <div className="w-full md:w-5/6 lg:w-3/4 mx-auto pb-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 w-full mx-auto content-center justify-center">
                    ...
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/zvVL380-udE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
