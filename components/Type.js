export function TitleHeading1({ children }) {
  return (
    <div className="justify-center pt-10 pb-3">
      <h1 className="text-2xl md:text-6xl pb-3 font-title text-blue ">
        {children}
      </h1>
...
export function TitleHeading2({ children }) {
  return (
    <>
      <h2 className="text-xl md:text-4xl font-title pl-3 pt-8 pb-3">
        {children}
      </h2>
      <svg
        viewBox="1 0 100 1"
...
export function Paragraph({ children }) {
  return (
    <>
      <p className="p-3 md:text-lg md:leading-relaxed text-justify md:text-left">
        {children}
      </p>
    </>
  );
...
export function CardHeading({ children }) {
  return (
    <div className="justify-center">
      <p className="text-lg md:text-3xl mx-1 md:mx-5 py-3 font-title">
        {children}
      </p>
      <svg
        viewBox="50 0 200 1"
