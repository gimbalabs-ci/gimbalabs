...
import TitleGroup, { TitleGroupDark } from "./gimbalgrid/sections/TitleGroup";
import useElementSize from "../lib/hooks/useElementSize";
import Testimony from "./gimbalgrid/sections/Testimony";
import TestimonyFull from "./gimbalgrid/sections/TestimonyFull";
import Letter from "./gimbalgrid/sections/Letter";
import HamburgerMenu from "./gimbalgrid/sections/HamburgerMenu";
import BlankWhite from "./gimbalgrid/sections/BlankWhite";
import InvisibleController from "./gimbalgrid/InvisibleController";
import DandelionPage from "./dandelion/DandelionPage";
import GBDandelion from "./gimbalgrid/gridboxes/GBDandelion";
import GBPBL from "./gimbalgrid/gridboxes/GBPBL";
import PBLPage from "./pbl/PBLPage";
          ...
          <div className="absolute top-0 right-2">
            <Link href={`/gimbalgrid?id=${slug}`}>
              <div
                role="button"
                className={`${bgColor} ${
                  bgColor === "bg-black2-900" ? "text-white" : "text-black2-900"
...
const GridBox = ({
  ...
  return (
    <motion.div
      id={`${id}`}
      className={`${style} group  min-h-8 relative  overflow-hidden  ${
