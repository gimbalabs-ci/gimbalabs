...
export default function calendar() {
    return (
        <div className="w-full md:w-5/6 lg:w-3/4 mx-auto pb-20">
            ...
            <p class="my-4 text-purple-700 text-lg">
                <a href="https://ics.teamup.com/feed/ksyq4sfs7367by71im/9336592.ics">Click here to subscribe to this Calendar via ics feed.</a>
            </p>
            <section>
